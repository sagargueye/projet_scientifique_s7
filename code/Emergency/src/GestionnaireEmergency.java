...
public final class GestionnaireEmergency {
	...
	public static void gestionIntervention() {
		...
		for (int i = 0; i < json_obj.length(); i++) {
		    ...
		    String incendie_link_intervention=POSTRequest("http://127.0.0.1:8080/incendieLinkIntervention/",test );
		    System.out.println(incendie_link_intervention);
			//System.out.println(GETRequest("http://127.0.0.1:8080/incendieLinkIntervention2/"));
			...
			System.out.println(listCamionsToJson(camionsSelectionnes));
			System.out.println(result);
			
		}
		System.out.println("_________FIN gestion invention________");
	}
	public static void main(String[] args) {
		...
		minuteur.schedule(tache, 0, 6000);
	}
}
